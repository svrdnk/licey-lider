...
(function () {
  ...
  const PAGES = [
    { key: 'home',      label: 'Головна',                href: '/' },
    { key: 'news',      label: 'Новини',                  href: '/news' },
    { key: 'gallery',   label: 'Галерея',                 href: '/gallery' },
    { key: 'team',      label: 'Команда',                 href: '/team' },
    { key: 'content',   label: 'Освітній контент',        href: '/education' },
    { key: 'events',    label: 'Позакласне навчання',     href: '/extracurricular' },
    { key: 'family',    label: 'Сімейне навчання',        href: '/family' },
    { key: 'psych',     label: 'Психологічна хвилинка',   href: '/psychology' },
    { key: 'parents',   label: 'Інформація для батьків',  href: '/parents' },
    { key: 'links',     label: 'Корисні посилання',       href: '/links' },
    { key: 'schedule',  label: 'Розклад',                 href: '/schedule' },
    { key: 'contact',   label: 'Контакти',                href: '/contacts' },
  ];
